        ...
        stage('Sonar') {
            steps {
               ...
               withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'sonar-user',
                    ...
                    sh 'java -cp /var/jenkins_home/.m2/repository/br/com/syncode/sonar-utils/0.0.1-SNAPSHOT/sonars-utils-*-jar-with-dependencies.jar  br.com.syncode.sonarutils.ValidadorDeMetasDeQualidade http://192.168.1.100 br.edu.faculdadedelta:delta-rent-a-car ${USERNAME} ${PASSWORD}'
               }
               /* script { 
